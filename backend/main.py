...
class Ui_Form_Video(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.checkBox.setText(_translate("Form", "Enable"))
        self.groupBox_3.setTitle(_translate("Form", "Random"))
        self.checkBox_3.setText(_translate("Form", "Randomized Frame"))
        self.checkBox_2.setText(_translate("Form", "Randomized Pixel"))
        self.groupBox_4.setTitle(_translate("Form", "Key"))
